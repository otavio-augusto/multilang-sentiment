var afinn = require('../build/output/build-all.json');
...
module.exports = function (phrase, lang, inject, callback) {
    ...
    // TODO: Pre-load the AFINN fuzzy DBs
    var afinnWords = [];
    var afinnLang = require('../build/output/build-' + lang + '.json');
    Object.keys(afinnLang).forEach(function(k) {
        afinnWords.push({
            word: k
        });
    });
    var fuse = new Fuse(afinnWords, fuseOpts);
